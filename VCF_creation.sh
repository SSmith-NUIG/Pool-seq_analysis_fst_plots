...
--pp-threads 8 \
-f /data/ssmith/c_l_genome/apis_c_l_genome.fa -o /data2/ssmith/lofreq_vcf/"$SLURM_ARRAY_TASK_ID"_"$sample_name".vcf \
--call-indels \
/data2/ssmith/bams/"$SLURM_ARRAY_TASK_ID"_"$sample_name"_indels.bam

# annotate VCF file using SnpEff
snpEff ann apiscl -canon /data2/ssmith/lofreq_vcf/"$SLURM_ARRAY_TASK_ID"_"$sample_name".vcf \
-s /data2/ssmith/snpeff_output/"$SLURM_ARRAY_TASK_ID"_"$sample_name"_summary.html \
> /data2/ssmith/snpeff_output/"$SLURM_ARRAY_TASK_ID"_"$sample_name".vcf
